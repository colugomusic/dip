...
static constexpr auto ARG_TRACK_HELP                 = "Update tag to latest commit hash for git dependencies. Use `--track` without args to update all git dependencies which specify `track = true`, or specify names of specific dependencies to update separated by commas, e.g. `--track = foo,bar,baz`.";
...
static constexpr auto KEY_CFGS                       = "cfgs";
static constexpr auto KEY_CMAKE_CONFIG               = "cmake-config";
...
static constexpr auto KEY_TAG                        = "tag";
static constexpr auto KEY_TRACK                      = "track";
static constexpr auto KEY_MD5                        = "md5";
static constexpr auto KEY_OVERRIDE_FIND_PACKAGE_NAME = "find-package-name";
