...
static constexpr auto ARG_REINSTALL_NAME_LONG = "--reinstall";
static constexpr auto ARG_REINSTALL_HELP      = "Reinstall dependencies. Specify names of specific dependencies to reinstall separated by commas, e.g. `--reinstall foo,bar,baz`.";
